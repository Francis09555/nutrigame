...
const enemyDefs={
 Burger:{icon:'🍔',hp:32,speed:68,damage:10,size:20},Fries:{icon:'🍟',hp:18,speed:93,damage:7,size:16},Pizza:{icon:'🍕',hp:80,speed:40,damage:15,size:24},Soda:{icon:'🥤',hp:40,speed:45,damage:9,size:19,shoot:1},Candy:{icon:'🍬',hp:34,speed:62,damage:8,size:17,split:1},Donut:{icon:'🍩',hp:47,speed:53,damage:11,size:20,teleport:1},IceCream:{icon:'🍦',hp:55,speed:49,damage:8,size:20,slow:1},Hotdog:{icon:'🌭',hp:62,speed:53,damage:13,size:21,charge:1},Chocolate:{icon:'🍫',hp:70,speed:46,damage:12,size:22,bounce:1},Cake:{icon:'🍰',hp:85,speed:39,damage:18,size:24,explode:1}
};
const weaponDefs={
...
function makePlayer(){return{x:0,y:0,r:19,hp:100,maxHp:100,speed:190,level:1,xp:100,nextXp:0,damage:1,attackSpeed:1,crit:.05,critDamage:1.75,regen:0,armor:0,projectileSpeed:1,size:1,count:0,knockback:1,cooldown:0,explosionRadius:1,areaDamage:1,piercing:0,ricochet:0,bounce:0,bossDamage:1,statusDuration:1,pickup:100,xpGain:100,luck:100,weapons:{carrot:{level:1,cd:0}},passives:{},ultimates:{},dashCd:0,dashMax:0,dashTime:0,invuln:0,slow:0,dir:{x:1,y:0},kills:0,companion:null,idle:0}}
